...
${alarm.alarmContent }
	...
	<table>
		<tr>
			...
			<td class = "td_right">
				<input type = "text" name = "writer" id = "writer" value = "${noticeInfo.noticeWriter }" readonly>
				<input type = "hidden" name = "user_id" id = "user_id" value = "${userInfo.user_id }"/>
				<input type = "hidden" name = "noticeNumber" id = "noticeNumber" value = "${noticeInfo.noticeNumber}"/>
			</td>
		</tr>
		<tr>
			<td class = "td_left">
			...
			<td class = "td_right">
				<input type = "text" name = "title" id = "title" value = "${noticeInfo.noticeTitle }">
			</td>
		</tr>	
		<tr>
			<td class = "td_left">
			...
			<td class = "td_right">
				<textarea name = "content" id = "content" rows = "25" cols = "40" style = "resize : none;">${noticeInfo.noticeContent }</textarea>
			</td>
		</tr>
		<tr>
			<td colspan = "2" style = "text-align : center">
				<input type = "submit" value = "수정"/>
				<a href = "noticeOpen?number=${noticeInfo.noticeNumber }&id=${userInfo.user_id }"><input type = "button" value = "취소"/></a>
			</td>
		</tr>
	</table>
</form>
