...
<body>
	<form action = "modifyPostingForm" method = "POST">
...
<hr>
	...
	<textarea rows = "10" cols = "10" id = "postingContent" name = "postingContent" onKeyUp = "fnChkByte(this, '1000')">${postingInfo.postingContent }</textarea><br>
	
	<span id = "byteInfo">0</span><span id = "byteInfo2">/1000byte</span><br>
	<input type = "submit" class = "postingCc" onclick = "postingSuccess()" value = "수정"/>
