...
<script>
	...
	function check(){
		var boardTitle = document.getElementById("subject");
...
${alarm.alarmContent }
	...
	<table>
		...
		<tr>
			...
			<td class = "td_right">
				<textarea name = "content" id = "content" rows = "25" cols = "40" style = "resize : none;"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan = "2" style = "text-align : center">
				...
				<a href = "boardView?id=${userInfo.user_id }&subject=all"><input type = "button" value = "뒤로가기"/></a>
			</td>
		</tr>
	</table>
</form>
