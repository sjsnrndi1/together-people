...
public class UserInfoVO {
	...
	public void setUser_re_level(int user_re_level) {
		this.user_re_level = user_re_level;
	}
	...
	public int getUser_reportNumber() {
		return user_reportNumber;
	}
	public void setUser_reportNumber(int user_reportNumber) {
		this.user_reportNumber = user_reportNumber;
	}
